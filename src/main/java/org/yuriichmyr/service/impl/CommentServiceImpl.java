...
import org.yuriichmyr.mapper.CommentToCommentDTOMapper;
import org.yuriichmyr.repository.CommentRepository;
import org.yuriichmyr.repository.PlayerRepository;
import org.yuriichmyr.service.CommentService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDTO createComment(CommentDTO commentDTO, Long id) {
        ...
        if(!PlayerRepository.checkSavedPlayers(id)){
